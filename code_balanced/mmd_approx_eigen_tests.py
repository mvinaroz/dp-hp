...
from mmd_approx_eigen import get_constants, hermite_polynomial_induction, phi_i_fun, sqrt_lambda_i_fun, \
  lambda_phi_induction, \
...
def check_approx_against_true():
  ...
  # compute approximate term k(x,y) using un-normalized hermite ploynomials as suggested in the paper
  lphi_normalized_x = normalized_batch_data_embedding_debug(x, n_degrees_balanced, c_tup, device, use_pi=use_pi,
                                                            eigenfun=False)
  lphi_normalized_y = normalized_batch_data_embedding_debug(y, n_degrees_balanced, c_tup, device, use_pi=use_pi,
                                                            eigenfun=False)
