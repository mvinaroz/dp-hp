...
def main():
    ...
    data_samps, label_samples, eval_func, class_centers = make_dataset(n_classes=n_classes,
                                                                         n_samples=n,
                                                                         n_rows=5,
                                                                         n_cols=5,
                                                                         noise_scale=0.2,
                                                                         discrete=False)
    plot_data(data_samps, label_samples, 'synth_2d_data_plot', center_frame=True, title='')
    print(eval_func(data_samps, label_samples))

    true_labels = torch.nn.functional.one_hot(torch.tensor(label_samples))
